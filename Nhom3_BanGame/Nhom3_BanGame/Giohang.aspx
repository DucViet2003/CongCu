<%@ Page Title="Giỏ Hàng" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Giohang.aspx.cs" Inherits="Nhom3_BanGame.Giohang" %>
        ...
        <div class="mycol-12">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowSorting="True" width="90%"
                ...
                <Columns>
                    ...
                    <%--<asp:BoundField DataField="IdTL" HeaderText="Mã đơn hàng" DataFormatString="{0:### ### ###}" >
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:BoundField>--%>

                    <asp:BoundField DataField="TenGame" HeaderText="Tên sản phẩm">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:BoundField>
